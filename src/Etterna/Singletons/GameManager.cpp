...
static const AutoMappings g_AutoKeyMappings_Dance = AutoMappings(
  ...
  AutoMappingEntry(0, Core::Input::Keys::Z, DANCE_BUTTON_LEFT, false),
  AutoMappingEntry(0, Core::Input::Keys::Period, DANCE_BUTTON_RIGHT, false),
  AutoMappingEntry(0, Core::Input::Keys::Comma, DANCE_BUTTON_UP, false),
  AutoMappingEntry(0, Core::Input::Keys::X, DANCE_BUTTON_DOWN, false),
