...
class HIDDevice
{
  ...
  protected:
	...
	virtual void AddElement(int usagePage,
							int usage,
	...
	// This adds the element with the given cookie to the queue to be notified
	// of state changes.
	...
	inline IOReturn SetReport(IOHIDReportType type,
							  UInt32 reportID,
							  void* buffer,
							  UInt32 size,
							  UInt32 timeoutMS)
	{
		return CALL(m_Interface,
					setReport,
					type,
					reportID,
					buffer,
  ...
  public:
	...
	void StartQueue(CFRunLoopRef loopRef,
